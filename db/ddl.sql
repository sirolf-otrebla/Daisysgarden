...
CREATE TABLE Sedi( id serial, immagine varchar(255), descrizione TEXT, orari varchar(255), telefono varchar(255), indirizzo varchar(255), email varchar(255), PRIMARY KEY(id));

CREATE TABLE Servizi( id serial, immagine varchar(255), intro TEXT, quando_utile TEXT, telefono varchar(255), email varchar(255), PRIMARY KEY(id));

CREATE TABLE Chi_Siamo( versione serial, storia TEXT, cosa_facciamo TEXT, introduzione TEXT, PRIMARY KEY(versione));

CREATE TABLE Contattaci( versione serial, responsabile varchar(255), indirizzo varchar(255), telefono varchar(255), email varchar(255), PRIMARY KEY(versione));
